...
st.markdown(
    ...
    .result-box {
        ...
        border-radius: 10px;
        margin-top: 20px;
        box-shadow: 0px 15px rgba(0,201,255,0.3);
    }
    .footer{
        text-align: center;
        margin-top: 50px;
...
def length_converter(value, from_unit, to_unit):
    length_units = {
        'Meters': 1, 'Kilometers': 0.001, 'Centimeters': 100, 'Millimeters': 1000, 'Miles': 0.000621371, 'Yards': 1.09361, 'Feet': 3.28084, 'Inches': 39.3701
    }
...
st.markdown("<div class='footer'>Created with Love by Tahira Ibrahim</div>", unsafe_allow_html=True)
